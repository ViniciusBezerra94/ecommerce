    ...
    <div class="container">
        <div class="row">                
            <div class="col-md-6">
                ...
                <form action="/hcode_ecommerce/login" id="login-form-wrap" class="login" method="post">
                    <h2>Acessar</h2>
                    ...
                    <p class="lost_password">
                        <a href="/hcode_ecommerce/forgot">Esqueceu a senha?</a>
                    </p>
            ...
            <div class="col-md-6">
                ...
                <form id="register-form-wrap" action="/hcode_ecommerce/register" class="register" method="post">
                    <h2>Criar conta</h2>
                    <p class="form-row form-row-first">
